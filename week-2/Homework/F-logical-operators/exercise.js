...
var htmlLevelAbove5 = 4 <= htmlLevel || htmlLevel >= htmlLevelAbove5;
var cssLevelAbove5 = 6  <= cssLevel || cssLevel >= cssLevelAbove5;

// Finish the next two statement
// Use the previous variables and logical operators
// Do not "hardcode" the answers
var cssAndHtmlAbove5 = htmlLevelAbove5 <= htmlLevel && cssLevelAbove5 >= cssLevel;
var cssOrHtmlAbove5 = htmlLevelAbove5 <= htmlLevel || cssLevelAbove5 >= cssLevel;;
